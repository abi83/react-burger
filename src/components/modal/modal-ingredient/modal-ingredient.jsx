...
export default function ModalIngredient ({ingredient}) {
  ...
  return (
    <div className={styles.card}>
      ...
      <img className={`${styles.mainImage} ml-4 mr-4`} src={ingredientDetail.image_large} alt={ingredientDetail.name}/>
      ...
      <ul className={styles.info}>
        <li>
          ...
          <span className='text text_type_digits-default text_color_inactive'>{ingredientDetail.calories}</span>
        </li>
        <li>
          <span className='text text_type_main-default text_color_inactive mb-2'>Белки, г</span>
          <span className='text text_type_digits-default text_color_inactive'>{ingredientDetail.proteins}</span>
        </li>
        <li>
          <span className='text text_type_main-default text_color_inactive mb-2'>Жиры, г</span>
          <span className='text text_type_digits-default text_color_inactive'>{ingredientDetail.fat}</span>
        </li>
        <li>
          <span className='text text_type_main-default text_color_inactive mb-2'>Углеводы, г</span>
          <span className='text text_type_digits-default text_color_inactive'>{ingredientDetail.carbohydrates}</span>
        </li>
